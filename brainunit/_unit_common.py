...
kilogramme2 = Unit.create((kilogramme ** 2).dim, name="kilogramme2", dispname=str(kilogramme) + "^2",
                          scale=kilogramme.scale * 2)
kilogramme3 = Unit.create((kilogramme ** 3).dim, name="kilogramme3", dispname=str(kilogramme) + "^3",
...
steradian2 = Unit.create((steradian ** 2).dim, name="steradian2", dispname=str(steradian) + "^2",
                         scale=steradian.scale * 2)
steradian3 = Unit.create((steradian ** 3).dim, name="steradian3", dispname=str(steradian) + "^3",
...
becquerel2 = Unit.create((becquerel ** 2).dim, name="becquerel2", dispname=str(becquerel) + "^2",
                         scale=becquerel.scale * 2)
becquerel3 = Unit.create((becquerel ** 3).dim, name="becquerel3", dispname=str(becquerel) + "^3",
...
Yradian2 = Unit.create((Yradian ** 2).dim, name="Yradian2", dispname=str(Yradian) + "^2", scale=Yradian.scale * 2)
Yradian3 = Unit.create((Yradian ** 3).dim, name="Yradian3", dispname=str(Yradian) + "^3", scale=Yradian.scale * 3)
ysteradian2 = Unit.create((ysteradian ** 2).dim, name="ysteradian2", dispname=str(ysteradian) + "^2",
                          scale=ysteradian.scale * 2)
ysteradian3 = Unit.create((ysteradian ** 3).dim, name="ysteradian3", dispname=str(ysteradian) + "^3",
                          scale=ysteradian.scale * 3)
zsteradian2 = Unit.create((zsteradian ** 2).dim, name="zsteradian2", dispname=str(zsteradian) + "^2",
                          scale=zsteradian.scale * 2)
zsteradian3 = Unit.create((zsteradian ** 3).dim, name="zsteradian3", dispname=str(zsteradian) + "^3",
                          scale=zsteradian.scale * 3)
asteradian2 = Unit.create((asteradian ** 2).dim, name="asteradian2", dispname=str(asteradian) + "^2",
                          scale=asteradian.scale * 2)
asteradian3 = Unit.create((asteradian ** 3).dim, name="asteradian3", dispname=str(asteradian) + "^3",
                          scale=asteradian.scale * 3)
fsteradian2 = Unit.create((fsteradian ** 2).dim, name="fsteradian2", dispname=str(fsteradian) + "^2",
                          scale=fsteradian.scale * 2)
fsteradian3 = Unit.create((fsteradian ** 3).dim, name="fsteradian3", dispname=str(fsteradian) + "^3",
                          scale=fsteradian.scale * 3)
psteradian2 = Unit.create((psteradian ** 2).dim, name="psteradian2", dispname=str(psteradian) + "^2",
                          scale=psteradian.scale * 2)
psteradian3 = Unit.create((psteradian ** 3).dim, name="psteradian3", dispname=str(psteradian) + "^3",
                          scale=psteradian.scale * 3)
nsteradian2 = Unit.create((nsteradian ** 2).dim, name="nsteradian2", dispname=str(nsteradian) + "^2",
                          scale=nsteradian.scale * 2)
nsteradian3 = Unit.create((nsteradian ** 3).dim, name="nsteradian3", dispname=str(nsteradian) + "^3",
                          scale=nsteradian.scale * 3)
usteradian2 = Unit.create((usteradian ** 2).dim, name="usteradian2", dispname=str(usteradian) + "^2",
                          scale=usteradian.scale * 2)
usteradian3 = Unit.create((usteradian ** 3).dim, name="usteradian3", dispname=str(usteradian) + "^3",
                          scale=usteradian.scale * 3)
msteradian2 = Unit.create((msteradian ** 2).dim, name="msteradian2", dispname=str(msteradian) + "^2",
                          scale=msteradian.scale * 2)
msteradian3 = Unit.create((msteradian ** 3).dim, name="msteradian3", dispname=str(msteradian) + "^3",
                          scale=msteradian.scale * 3)
csteradian2 = Unit.create((csteradian ** 2).dim, name="csteradian2", dispname=str(csteradian) + "^2",
                          scale=csteradian.scale * 2)
csteradian3 = Unit.create((csteradian ** 3).dim, name="csteradian3", dispname=str(csteradian) + "^3",
                          scale=csteradian.scale * 3)
dsteradian2 = Unit.create((dsteradian ** 2).dim, name="dsteradian2", dispname=str(dsteradian) + "^2",
                          scale=dsteradian.scale * 2)
dsteradian3 = Unit.create((dsteradian ** 3).dim, name="dsteradian3", dispname=str(dsteradian) + "^3",
                          scale=dsteradian.scale * 3)
dasteradian2 = Unit.create((dasteradian ** 2).dim, name="dasteradian2", dispname=str(dasteradian) + "^2",
                           scale=dasteradian.scale * 2)
dasteradian3 = Unit.create((dasteradian ** 3).dim, name="dasteradian3", dispname=str(dasteradian) + "^3",
                           scale=dasteradian.scale * 3)
hsteradian2 = Unit.create((hsteradian ** 2).dim, name="hsteradian2", dispname=str(hsteradian) + "^2",
                          scale=hsteradian.scale * 2)
hsteradian3 = Unit.create((hsteradian ** 3).dim, name="hsteradian3", dispname=str(hsteradian) + "^3",
                          scale=hsteradian.scale * 3)
ksteradian2 = Unit.create((ksteradian ** 2).dim, name="ksteradian2", dispname=str(ksteradian) + "^2",
                          scale=ksteradian.scale * 2)
ksteradian3 = Unit.create((ksteradian ** 3).dim, name="ksteradian3", dispname=str(ksteradian) + "^3",
                          scale=ksteradian.scale * 3)
Msteradian2 = Unit.create((Msteradian ** 2).dim, name="Msteradian2", dispname=str(Msteradian) + "^2",
                          scale=Msteradian.scale * 2)
Msteradian3 = Unit.create((Msteradian ** 3).dim, name="Msteradian3", dispname=str(Msteradian) + "^3",
                          scale=Msteradian.scale * 3)
Gsteradian2 = Unit.create((Gsteradian ** 2).dim, name="Gsteradian2", dispname=str(Gsteradian) + "^2",
                          scale=Gsteradian.scale * 2)
Gsteradian3 = Unit.create((Gsteradian ** 3).dim, name="Gsteradian3", dispname=str(Gsteradian) + "^3",
                          scale=Gsteradian.scale * 3)
Tsteradian2 = Unit.create((Tsteradian ** 2).dim, name="Tsteradian2", dispname=str(Tsteradian) + "^2",
                          scale=Tsteradian.scale * 2)
Tsteradian3 = Unit.create((Tsteradian ** 3).dim, name="Tsteradian3", dispname=str(Tsteradian) + "^3",
                          scale=Tsteradian.scale * 3)
Psteradian2 = Unit.create((Psteradian ** 2).dim, name="Psteradian2", dispname=str(Psteradian) + "^2",
                          scale=Psteradian.scale * 2)
Psteradian3 = Unit.create((Psteradian ** 3).dim, name="Psteradian3", dispname=str(Psteradian) + "^3",
                          scale=Psteradian.scale * 3)
Esteradian2 = Unit.create((Esteradian ** 2).dim, name="Esteradian2", dispname=str(Esteradian) + "^2",
                          scale=Esteradian.scale * 2)
Esteradian3 = Unit.create((Esteradian ** 3).dim, name="Esteradian3", dispname=str(Esteradian) + "^3",
...
dacoulomb2 = Unit.create((dacoulomb ** 2).dim, name="dacoulomb2", dispname=str(dacoulomb) + "^2",
                         scale=dacoulomb.scale * 2)
dacoulomb3 = Unit.create((dacoulomb ** 3).dim, name="dacoulomb3", dispname=str(dacoulomb) + "^3",
...
dasiemens2 = Unit.create((dasiemens ** 2).dim, name="dasiemens2", dispname=str(dasiemens) + "^2",
                         scale=dasiemens.scale * 2)
dasiemens3 = Unit.create((dasiemens ** 3).dim, name="dasiemens3", dispname=str(dasiemens) + "^3",
...
Ylux2 = Unit.create((Ylux ** 2).dim, name="Ylux2", dispname=str(Ylux) + "^2", scale=Ylux.scale * 2)
Ylux3 = Unit.create((Ylux ** 3).dim, name="Ylux3", dispname=str(Ylux) + "^3", scale=Ylux.scale * 3)
ybecquerel2 = Unit.create((ybecquerel ** 2).dim, name="ybecquerel2", dispname=str(ybecquerel) + "^2",
                          scale=ybecquerel.scale * 2)
ybecquerel3 = Unit.create((ybecquerel ** 3).dim, name="ybecquerel3", dispname=str(ybecquerel) + "^3",
                          scale=ybecquerel.scale * 3)
zbecquerel2 = Unit.create((zbecquerel ** 2).dim, name="zbecquerel2", dispname=str(zbecquerel) + "^2",
                          scale=zbecquerel.scale * 2)
zbecquerel3 = Unit.create((zbecquerel ** 3).dim, name="zbecquerel3", dispname=str(zbecquerel) + "^3",
                          scale=zbecquerel.scale * 3)
abecquerel2 = Unit.create((abecquerel ** 2).dim, name="abecquerel2", dispname=str(abecquerel) + "^2",
                          scale=abecquerel.scale * 2)
abecquerel3 = Unit.create((abecquerel ** 3).dim, name="abecquerel3", dispname=str(abecquerel) + "^3",
                          scale=abecquerel.scale * 3)
fbecquerel2 = Unit.create((fbecquerel ** 2).dim, name="fbecquerel2", dispname=str(fbecquerel) + "^2",
                          scale=fbecquerel.scale * 2)
fbecquerel3 = Unit.create((fbecquerel ** 3).dim, name="fbecquerel3", dispname=str(fbecquerel) + "^3",
                          scale=fbecquerel.scale * 3)
pbecquerel2 = Unit.create((pbecquerel ** 2).dim, name="pbecquerel2", dispname=str(pbecquerel) + "^2",
                          scale=pbecquerel.scale * 2)
pbecquerel3 = Unit.create((pbecquerel ** 3).dim, name="pbecquerel3", dispname=str(pbecquerel) + "^3",
                          scale=pbecquerel.scale * 3)
nbecquerel2 = Unit.create((nbecquerel ** 2).dim, name="nbecquerel2", dispname=str(nbecquerel) + "^2",
                          scale=nbecquerel.scale * 2)
nbecquerel3 = Unit.create((nbecquerel ** 3).dim, name="nbecquerel3", dispname=str(nbecquerel) + "^3",
                          scale=nbecquerel.scale * 3)
ubecquerel2 = Unit.create((ubecquerel ** 2).dim, name="ubecquerel2", dispname=str(ubecquerel) + "^2",
                          scale=ubecquerel.scale * 2)
ubecquerel3 = Unit.create((ubecquerel ** 3).dim, name="ubecquerel3", dispname=str(ubecquerel) + "^3",
                          scale=ubecquerel.scale * 3)
mbecquerel2 = Unit.create((mbecquerel ** 2).dim, name="mbecquerel2", dispname=str(mbecquerel) + "^2",
                          scale=mbecquerel.scale * 2)
mbecquerel3 = Unit.create((mbecquerel ** 3).dim, name="mbecquerel3", dispname=str(mbecquerel) + "^3",
                          scale=mbecquerel.scale * 3)
cbecquerel2 = Unit.create((cbecquerel ** 2).dim, name="cbecquerel2", dispname=str(cbecquerel) + "^2",
                          scale=cbecquerel.scale * 2)
cbecquerel3 = Unit.create((cbecquerel ** 3).dim, name="cbecquerel3", dispname=str(cbecquerel) + "^3",
                          scale=cbecquerel.scale * 3)
dbecquerel2 = Unit.create((dbecquerel ** 2).dim, name="dbecquerel2", dispname=str(dbecquerel) + "^2",
                          scale=dbecquerel.scale * 2)
dbecquerel3 = Unit.create((dbecquerel ** 3).dim, name="dbecquerel3", dispname=str(dbecquerel) + "^3",
                          scale=dbecquerel.scale * 3)
dabecquerel2 = Unit.create((dabecquerel ** 2).dim, name="dabecquerel2", dispname=str(dabecquerel) + "^2",
                           scale=dabecquerel.scale * 2)
dabecquerel3 = Unit.create((dabecquerel ** 3).dim, name="dabecquerel3", dispname=str(dabecquerel) + "^3",
                           scale=dabecquerel.scale * 3)
hbecquerel2 = Unit.create((hbecquerel ** 2).dim, name="hbecquerel2", dispname=str(hbecquerel) + "^2",
                          scale=hbecquerel.scale * 2)
hbecquerel3 = Unit.create((hbecquerel ** 3).dim, name="hbecquerel3", dispname=str(hbecquerel) + "^3",
                          scale=hbecquerel.scale * 3)
kbecquerel2 = Unit.create((kbecquerel ** 2).dim, name="kbecquerel2", dispname=str(kbecquerel) + "^2",
                          scale=kbecquerel.scale * 2)
kbecquerel3 = Unit.create((kbecquerel ** 3).dim, name="kbecquerel3", dispname=str(kbecquerel) + "^3",
                          scale=kbecquerel.scale * 3)
Mbecquerel2 = Unit.create((Mbecquerel ** 2).dim, name="Mbecquerel2", dispname=str(Mbecquerel) + "^2",
                          scale=Mbecquerel.scale * 2)
Mbecquerel3 = Unit.create((Mbecquerel ** 3).dim, name="Mbecquerel3", dispname=str(Mbecquerel) + "^3",
                          scale=Mbecquerel.scale * 3)
Gbecquerel2 = Unit.create((Gbecquerel ** 2).dim, name="Gbecquerel2", dispname=str(Gbecquerel) + "^2",
                          scale=Gbecquerel.scale * 2)
Gbecquerel3 = Unit.create((Gbecquerel ** 3).dim, name="Gbecquerel3", dispname=str(Gbecquerel) + "^3",
                          scale=Gbecquerel.scale * 3)
Tbecquerel2 = Unit.create((Tbecquerel ** 2).dim, name="Tbecquerel2", dispname=str(Tbecquerel) + "^2",
                          scale=Tbecquerel.scale * 2)
Tbecquerel3 = Unit.create((Tbecquerel ** 3).dim, name="Tbecquerel3", dispname=str(Tbecquerel) + "^3",
                          scale=Tbecquerel.scale * 3)
Pbecquerel2 = Unit.create((Pbecquerel ** 2).dim, name="Pbecquerel2", dispname=str(Pbecquerel) + "^2",
                          scale=Pbecquerel.scale * 2)
Pbecquerel3 = Unit.create((Pbecquerel ** 3).dim, name="Pbecquerel3", dispname=str(Pbecquerel) + "^3",
                          scale=Pbecquerel.scale * 3)
Ebecquerel2 = Unit.create((Ebecquerel ** 2).dim, name="Ebecquerel2", dispname=str(Ebecquerel) + "^2",
                          scale=Ebecquerel.scale * 2)
Ebecquerel3 = Unit.create((Ebecquerel ** 3).dim, name="Ebecquerel3", dispname=str(Ebecquerel) + "^3",
...
dasievert2 = Unit.create((dasievert ** 2).dim, name="dasievert2", dispname=str(dasievert) + "^2",
                         scale=dasievert.scale * 2)
dasievert3 = Unit.create((dasievert ** 3).dim, name="dasievert3", dispname=str(dasievert) + "^3",
...
additional_units = [
    ...
    yliter, zliter, aliter, fliter, pliter, nliter, uliter, mliter, cliter, dliter, liter, daliter, hliter, kliter,
    Mliter, Gliter, Tliter, Pliter, Eliter, Zliter, Yliter, ylitre, zlitre, alitre, flitre, plitre, nlitre, ulitre,
    mlitre, clitre, dlitre, litre, dalitre, hlitre, klitre, Mlitre, Glitre, Tlitre, Plitre, Elitre, Zlitre, Ylitre, ]
