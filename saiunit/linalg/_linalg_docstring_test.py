...
class TestInvDocstring:
    ...
    def test_inv_identity_reconstruction(self):
        ...
        a = jnp.array([[2., 1.],
                        [1., 3.]]) * u.meter
        a_inv = u.linalg.inv(a)
        product = u.linalg.matmul(a, a_inv)
...
class TestSolveDocstring:
    ...
    def test_solve_reconstructs_rhs(self):
        ...
        A = jnp.array([[1., 2.],
                        [3., 4.]]) * u.meter
        b = jnp.array([5., 6.]) * u.second
        x = u.linalg.solve(A, b)
        reconstructed = u.linalg.matmul(A, x)
